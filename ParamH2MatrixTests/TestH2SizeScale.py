...
for kernel in kernels:
    ...
    for size_label in sizes:
        ...
        PH = H2Matrix(kernel, Block_T, num_nodes, translation_invariant=True, ep=epsilon)

        ff_times_ph, nf_times_ph, mvm_times_ph, err_ph_list, cm_sizes = [], [], [], [], []
        ...
        online_data.append({
            ...
            "cm_ratio": float(np.mean(cm_sizes) / (sz * sz)),
